...
class JsonSerializableResearchRoster {
    ...
    /**
     * Constructs a {@code JsonSerializableResearchRoster} with the given persons.
     */
    @JsonCreator
    public JsonSerializableResearchRoster(@JsonProperty("persons") List<JsonAdaptedPerson> persons) {
     ...
     *
     * @param source future changes to this will not affect the created {@code JsonSerializableResearchRoster}.
     */
    public JsonSerializableResearchRoster(ReadOnlyResearchRoster source) {
